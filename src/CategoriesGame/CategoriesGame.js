...
const CATEGORIES = { Animals, Fruits, Vegetables, Colors, Countries, Sports, Jobs, Vehicles, Instruments, Planets, Elements, Languages, Flower, Buildings, Holidays };
...
const CategoriesGame = () => {
          ...
          <label>
            ...
            <div>
              <input
                ...
                name="mode"
                value="Easy"
                checked={localSettings.mode === 'Easy'}
            ...
            <div>
              <input
                ...
                name="mode"
                value="Medium"
                checked={localSettings.mode === 'Medium'}
                onChange={(e) => setLocalSettings({ ...localSettings, mode: e.target.value })}
              />
              Medium
            </div>
            <div>
              <input
                ...
                name="mode"
                value="Hard"
                checked={localSettings.mode === 'Hard'}
                onChange={(e) => setLocalSettings({ ...localSettings, mode: e.target.value })}
              />
              Hard
            </div>
  ...
  useEffect(() => {
    ...
    if (waitCounter > 0) {
      ...
      setGameState(prev => ({ ...prev, showWaitTime: false, showSecondChoices: true }));
    }
  ...
  const submitChoices = () => {
    ...
    setGameState(prev => ({ ...prev, showChoices: false, showWaitTime: true }));
  };

  const submitFinalChoices = () => {
    setGameState(prev => ({ ...prev, showResult: true, showSecondChoices: false }));
  };
